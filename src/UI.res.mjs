...
var testingAllPossibleValues = Html.html([
      "<ul>",
      "</ul>"
    ], [{
        NAME: "Elements",
        VAL: [
          ...
          Html.html([
                "<li>it allows for empty elements like ",
                "</li>"
              ], [{
                  NAME: "Empty",
                  VAL: undefined
...
var header = Html.styled("header", Html.css(["\n    background-color: rgb(20, 22, 44);\n    color: whitesmoke;\n    min-height: 50px;\n    font-family: Verdana;\n    font-weight: 700;\n    font-size: 2em;\n    text-indent: 2em;\n    font-variant: small-caps;\n"], []));

var content = Html.styled("content", Html.css(["\n    background-color: gainsboro;\n    color: black;\n    min-height: calc(100vh - 100px);\n    display: block;\n    position: relative;\n    overflow: hidden;\n    user-select: none;\n"], []));
...
export {
  ...
  cursedLogo ,
  page ,
  testingAllPossibleValues ,
  header ,
  content ,
  footer ,
}
/* cursedLogo Not a pure module */
