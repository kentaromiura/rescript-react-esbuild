...
// testing uhtml svg, notice inline css:
let cursedLogo = Html.svg`<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
 width="1024.000000pt" height="768.000000pt" viewBox="0 0 1024.000000 768.000000"
 preserveAspectRatio="xMidYMid meet" class="${#Str(
  Html.css`
    position: absolute;
    top: 0;
    left: 0;
...
let page = (header, content, footer) =>
  Html.html`
    ${#Element(header)}${#Element(content)}${#Element(footer)}`

let testingAllPossibleValues = Html.html`<ul>${#Elements([
  Html.html`<li>String are of course ${#Str("possible")}</li>`,
  Html.html`<li>Int are strongly typed: ${#Int(1)}</li>`,
  Html.html`<li>Floats are also ok ${#Number(1.03)}</li>`,
  Html.html`<li>it allows for empty elements like ${#Empty()}</li>`,
])}</ul>`
...
// footer doesn't use styled, works just the same.
let footer = Html.html`<footer class="${#Str(
  Html.css`
    background-color: rgb(20, 22, 44);
    color: rgb(36, 37, 56);
    min-height: 50px;
